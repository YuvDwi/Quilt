          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button
                ...
                disabled={isLoading}
                className="bg-white text-black px-4 py-2 rounded hover:bg-gray-100 transition-colors disabled:opacity-50"
              >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left bg-black/20 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20">
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-12 leading-relaxed max-w-2xl">
                  ...
                  But LLMs need context, structure, and meaning — not clunky user interfaces to drain compute power.
                </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Vector Intelligence</h3>
              <p className="text-gray-400 leading-relaxed">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Connect GitHub</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Parse Content</h3>
              <p className="text-sm text-gray-400 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Generate Embeddings</h3>
              <p className="text-sm text-gray-400 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Search Ready</h3>
              <p className="text-sm text-gray-400 leading-relaxed">
